...
def test_text_abs(args, device_id, pt, step):
    ...
    symbols = {
        'BOS': tokenizer.vocab[args.decoder_symbol_mapping['BOS']],
        'EOS': tokenizer.vocab[args.decoder_symbol_mapping['EOS']],
        'PAD': tokenizer.vocab[args.decoder_symbol_mapping['PAD']],
        'EQQ': tokenizer.vocab[args.decoder_symbol_mapping['EQQ']]
    }
    predictor = build_predictor(args, tokenizer, symbols, model, logger)
    predictor.translate(test_iter, step)
